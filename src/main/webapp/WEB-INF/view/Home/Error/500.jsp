                        ...
                        <center>
                            <form name="formsearch" action="/search" id="formkeyword">
                                <div class="input-container">
                                    <input type="text" class="left" name="query" size="24" value="在这里面搜索..."
                                           onfocus="if(this.value == '在这里面搜索...'){this.value='';}"
                                           onblur="if(this.value==''){this.value='在这里面搜索...';}" id="inputString"
                            ...
                            <div id="btn">
                                ...
                                <a class="button" href="http://wpa.qq.com/msgrd?v=3&uin=330079598&site=qq&menu=yes">联系站长</a>
                                <div class="clear" ></div>
                            </div>
                        </center>
                    </div>
